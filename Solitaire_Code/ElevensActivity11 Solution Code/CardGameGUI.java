...
public class CardGameGUI extends JFrame implements ActionListener {
    ...
    private static final int BUTTON_LEFT = 1125; //
    ...
    private static final int LABEL_LEFT = 1125;
    ...
    private JLabel sumMsg;
    /** The "Sum: n" message. */
    private JLabel winMsg;
    /** The "Turns taken: n" message. */
    private JLabel turnsMsg;
    /** The card displays. */
    ...
    public CardGameGUI(Board gameBoard) {
        ...
        // Initialize cardCoords using 11 cards per row
    ...
    public void repaint() {
        ...
        sumMsg.setText("Sum: " + sum);
        sumMsg.setVisible(true);
        

        turnsMsg.setText("Turns: " + turns);
        turnsMsg.setVisible(true);
    ...
    private void initDisplay()  {
        ...
        sumMsg = new JLabel(
            "Sum: ");
        panel.add(sumMsg);
        sumMsg.setBounds(LABEL_LEFT, LABEL_TOP, 250, 30);
        ...
        turnsMsg = new JLabel("Turns: ");
        turnsMsg.setBounds(LABEL_LEFT, LABEL_TOP + 2 * LABEL_HEIGHT_INC,
                                  250, 30);
        panel.add(turnsMsg);
